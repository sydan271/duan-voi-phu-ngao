...
void SinhVien::setMssv(long long m)
{
    mssv = m;
}
...
void SinhVien::setName(string n)
{
    name = n;
}
...
void SinhVien::setCourse(string c)
{
    course = c;
}

string SinhVien::getCourse()
{
    return course; 
}

void SinhVien::setMark(double ma)
{
    mark = ma;
}
...
void SinhVien::printSV()
{
    ...
    cout << mssv << "\t" << name << "\t" << course << "\t" << fixed << setprecision(2) << mark << endl;
}

// void topRow()
// {
//     cout << "============================================================================" << endl;
//     cout << "MSSV                      Name                 Course                   Mark" << endl;
//     cout << "============================================================================" << endl;
// }
